  ...
  return (
    ...
    >
      <div className='flex flex-1 flex-col'>
        ...
        text-4xl capitalize lg:max-w-lg font-bold'>
       We Provide You
        ...
        <p className='mt-6 lg:max-w-lg info-text'>Our dedication to detail and excellence 
          ensures your satisfation</p>
          <div className='mt-8'>
        <Button label='View Details'/>
          </div>
      </div>
      <div className='flex flex-1 justify-center items-center'>
        <img src={shoe8} alt="shoes8" width={570} 
        height={522} className='object-contain md:block hidden' />
