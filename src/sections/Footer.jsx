      ...
      items-start gap-20 flex-wrap max-lg:flex-col'>
        <div className='flex flex-col items-start'>
          ...
          font-montserrat text-white-400 sm:max-w-sm'>
            Get shoes ready
           for the new term at your nearest Nike store.
          ...
          <div className='flex items-center gap-5 my-8'>
            {
              socialMedia.map((icon,ind) => (
                ...
                items-center w-12 h-12 bg-white rounded-full' key={ind}>
                ...
                <ul>
                  {
                    section.links.map((link,ind) => (
                      <li key={ind} className='mt-3 text-white-400 font-montserrat
                      text-base leading-normal hover:text-slate-gray
                      cursor-pointer'><a href="#home">{link.name}</a></li>
                    ))
                  }
                </ul>
              </div>
